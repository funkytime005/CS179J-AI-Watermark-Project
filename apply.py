...
def set_value(channel): # sets individual color channel value within one pixel
    return min((round(channel / 10) * 10), 255) # divides channel value by 10, rounds to nearest whole number, then appends 0. effectively rounds channel value to nearest 10.
                                                # if rounded value > 255 (max value in rgb colorspace), return 255
